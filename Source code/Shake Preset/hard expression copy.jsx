...
var positionXY = effectController("Position");
...
// var numKeys = positionXY.numKeys;
// var firstKeyTime = positionXY.key(1).time;
// var lastKeyTime = positionXY.key(numKeys).time;
// var cycleDuration = lastKeyTime - firstKeyTime;
// var cycleTime;

// // Ping-pong loop
// if (time < firstKeyTime) {
//     var preCycleTime = (firstKeyTime - time) % (2 * cycleDuration);
//     if (preCycleTime > cycleDuration) {
//         preCycleTime = 2 * cycleDuration - preCycleTime;
//     }
//     cycleTime = preCycleTime;
// } else {
//     var cycleTime = (multiplierValue + phase - firstKeyTime) % (2 * cycleDuration);

//     if (cycleTime > cycleDuration) {
//         cycleTime = 2 * cycleDuration - cycleTime;
//     }
// }

// var cycledPositionXY = positionXY.valueAtTime(firstKeyTime + cycleTime);
// var finalPosition = cycledPositionXY * ampMultiplier;
